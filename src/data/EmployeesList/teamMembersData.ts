...
const teamMembersData: teamMembersDataInterface[] = [
  ...
  },
  {
    ...
    jobTitle: 'Ведущий специалист по ипотеке, специалист по продажам',
  ...
  },
  {
    ...
    role: 'employee',
    name: 'Игорь Степыгин',
    jobTitle: 'Специалист по оформлению документов (межевание, постановка на кадастровый учет регистрация прав собственности и т.д.)',
    quote: 'Laborum laboris culpa laborum deserunt culpa enim aliquip amet veniam ut.',
    photo: Person2,
    contacts: {
      phone: '+79213778477',
