...
const statisticalIndicatorsData: statisticalIndicatorsInterface[] = [
  ...
  },
  {
    ...
    statIndicator: '45',
    statLabel: 'млн. руб.',
    description: 'Наши специалисты отлично разбираются в\u00A0налоговом праве. И\u00A0всегда могут проконсультировать, как абсолютно законным способом уменьшить налог с\u00A0продажи Вашего объекта недвижимости.'
  },
  {
    _id: 4,
