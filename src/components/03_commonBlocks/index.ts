...
export * from './ServicesPagesCommonComponents/ServicesCardTemplate/ServicesCardTemplate';
...
export * from './ServicesPagesCommonComponents/ServicesOffers/ServicesOffers';
